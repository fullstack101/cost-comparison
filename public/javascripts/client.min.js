...
httpJSONRequest("http://cost-comparison.azurewebsites.net/numbeo").then(function (json) {
    ...
    var chart = d3.select(".chart").attr("width", width).attr("height", barHeight * json[0].prices.length);

    var bar = chart.selectAll("g").data(json[0].prices).enter().append("g").attr("transform", function (d, i) {
